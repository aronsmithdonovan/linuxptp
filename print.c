...
///////////////////////////////////////////////////////////////////////////////////////////////////////////// print_set_progname used in ptp4l.c
void print_set_progname(const char *name)
{
	progname = name;
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////// print_set_tag used in ptp4l.c
void print_set_tag(const char *tag)
{
	message_tag = tag;
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////// print_set_syslog used in ptp4l.c
void print_set_syslog(int value)
{
	use_syslog = value ? 1 : 0;
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////// print_set_level used in ptp4l.c
void print_set_level(int level)
{
	print_level = level;
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////// print_set_verbose used in ptp4l.c
