...
#define ALT_MASTER     (1<<0)  // 00000001
#define TWO_STEP       (1<<1)  // 00000010
#define UNICAST        (1<<2)  // 00000100

/* Bits for flagField[1] */
#define LEAP_61        (1<<0)  // 00000001
#define LEAP_59        (1<<1)  // 00000010
#define UTC_OFF_VALID  (1<<2)  // 00000100
#define PTP_TIMESCALE  (1<<3)  // 00001000
#define TIME_TRACEABLE (1<<4)  // 00010000
#define FREQ_TRACEABLE (1<<5)  // 00100000
#define SYNC_UNCERTAIN (1<<6)  // 01000000
